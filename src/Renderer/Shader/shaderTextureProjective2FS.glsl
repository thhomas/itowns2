...
// CAM 0,300
            ...
            if ((corrected0bis.x>0. && corrected0bis.x<1. && corrected0bis.y>0. && corrected0bis.y<1.) && v_texcoord0bis.w>0.){
                ...
                colorbis = texture2D(texture0bis,corrected0bis); //vec4(1,0,0,1);//texture2D(texture0bis,corrected0bis);
...
// CAM 1,301
             ...
             if ((corrected1bis.x>0. && corrected1bis.x<1. && corrected1bis.y>0. && corrected1bis.y<1.) && v_texcoord1bis.w>0.){
                       ...
                       colorbis = texture2D(texture1bis,corrected1bis); //vec4(0,1,0,1);// texture2D(texture1bis,corrected1bis);
...
// CAM 2,302
            ...
            if ((corrected2bis.x>0. && corrected2bis.x<1. && corrected2bis.y>0. && corrected2bis.y<1.) && v_texcoord2bis.w>0.){
                   ...
                   colorbis = texture2D(texture2bis,corrected2bis); //vec4(0,0,1,1);//texture2D(texture2bis,corrected2bis);
                if(blending){
                     // Blending cam2/cam3
...
// CAM 3,303
            ...
            if ((corrected3bis.x>0.01 && corrected3bis.x<0.99 && corrected3bis.y>0. && corrected3bis.y<1.) && v_texcoord3bis.w>0.){
                   ...
                   colorbis = texture2D(texture3bis,corrected3bis); //vec4(1,1,0,1);//texture2D(texture3bis,corrected3bis);
...
// CAM 4,304
            ...
            if ((corrected4bis.x>0. && corrected4bis.x<1. && corrected4bis.y>0. && corrected4bis.y<1.) && v_texcoord4bis.w>0.){
                ...
                colorbis = texture2D(texture4bis,corrected4bis); //vec4(1,0,1,1);//	
